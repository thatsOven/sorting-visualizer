new class BWGradientDataTrace: BaseDataTrace {
            ...
            if len(array) > sortingVisualizer.graphics.resolution.x {
                ...
                unchecked: repeat sortingVisualizer.graphics.resolution.x {
                    ...
                    if array[idx].value < 0 {
                        sortingVisualizer.graphics.fastRectangle(pos, this.UNIT_VECTOR, (40, 40, 40), 0, True, this.mainSurf);
                    } else {
                        sortingVisualizer.graphics.fastRectangle(pos, this.UNIT_VECTOR, [40 + int(array[idx].value * this.colorConstant)] * 3, 0, True, this.mainSurf);
                    }
                ...
                for i = this.lineSize // 2; i < sortingVisualizer.graphics.resolution.x; i += this.lineSize {
                    ...
                    if array[idx].value < 0 {
                        sortingVisualizer.graphics.fastRectangle(pos, vec, (40, 40, 40), 0, True, this.mainSurf);
                    } else {
                        sortingVisualizer.graphics.fastRectangle(pos, vec, [40 + int(array[idx].value * this.colorConstant)] * 3, 0, True, this.mainSurf);
                    }
        ...
        if arrayValues != this.oldAux {
            ...
            if len(array) > this.auxResolution.x {
                ...
                unchecked: repeat this.auxResolution.x {
                    ...
                    if array[idx].value < 0 {
                        sortingVisualizer.graphics.fastRectangle(pos, this.UNIT_VECTOR, (40, 40, 40), 0, True, this.auxSurf);
                    } else {
                        sortingVisualizer.graphics.fastRectangle(pos, this.UNIT_VECTOR, [40 + int(array[idx].value * this.auxColorConstant)] * 3, 0, True, this.auxSurf);
                    }
                ...
                for i = this.auxLineSize // 2; i < this.auxResolution.x; i += this.auxLineSize {
                    ...
                    if array[idx].value < 0 {
                        sortingVisualizer.graphics.fastRectangle(pos, vec, (40, 40, 40), 0, True, this.auxSurf);
                    } else {
                        sortingVisualizer.graphics.fastRectangle(pos, vec, [40 + int(array[idx].value * this.auxColorConstant)] * 3, 0, True, this.auxSurf);
                    }
